<?php
  foreach ($data["tindangxem"] as $key => $value) {
    # code...
?>
<h1 class="title"><?php echo $value['TieuDe']; ?></h1>
<div class="des">
...
<div class="number_count"><span id="like-total-1000000-3023795"><?php echo $value['SoLanXem']; ?></span></div>
<!--face-->
...
<div class="clear"></div>
	<ul>
        ...
        <li>       
             <a href="#"><img src="<?=PATH?>/public/upload/tintuc/19-2436-1406522072_300x180.jpg" alt="Người nhà nạn nhân MH370 an ủi thân nhân hành khách MH17"></a> <br />
