...
<link rel="stylesheet" type="text/css" href="<?=PATH?>/public/css/layout.css" />
</head>

<body>
<div id="wrap-vp">
	<div id="header-vp">
    	<div id="logo"><img src="<?=PATH?>/public/images/logo.gif" /></div>
    </div>
    ...
    <div id="footer">
        ...
        <div class="ft-bot">
            <div class="bot1"><img src="<?=PATH?>/public/images/logo.gif" /></div>
            <div class="bot2">
