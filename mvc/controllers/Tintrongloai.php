<?php
	class Tintrongloai extends Controller{
		function SayHi(){
	    ...
	    function LoaiTin($idLT,$trang,$sotinmottrang){
	        ...
	        $this->view("master1", [
	            ...
	            "tinmoinhat_loaitin11_mottin"=>json_decode($master_model3->tinmoinhat_LoaiTin_mottin(11),true),
	            "tinmoinhat_loaitin11_batin"=>json_decode($master_model3->tinmoinhat_LoaiTin_batin(11),true),
	            "loaitincanhienthi"=>json_decode($master_model3->tin_theoloaitin($idLT),true),
	            "loaitincanhienthi_phantrang"=>json_decode($master_model3->tindangxem_phantrang($idLT,$sotinmottrang *($trang-1),$sotinmottrang),true),
